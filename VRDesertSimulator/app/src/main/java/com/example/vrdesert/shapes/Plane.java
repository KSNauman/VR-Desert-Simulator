...
public class Plane {
    ...
    static float colors[] = {
            1.0f, 0.85f, 0.50f, 1.0f, // top left (bright orange sand)
            0.80f, 0.60f, 0.25f, 1.0f, // bottom left (darker desert dune)
            0.90f, 0.70f, 0.35f, 1.0f, // bottom right
            
            1.0f, 0.85f, 0.50f, 1.0f, // top left
            0.90f, 0.70f, 0.35f, 1.0f, // bottom right
            0.80f, 0.60f, 0.25f, 1.0f  // top right
    };
